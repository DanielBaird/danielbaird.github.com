...
This web tool and its output are free for personal use.  If you want to use this tool or its output in your paid job, or you want to distribute it or an altered version of it, you must get my permission first.  "Email me":{{ site.baseurl }} and let me know what you're intending.
